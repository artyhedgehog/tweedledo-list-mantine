...
export function useConfig(): {
    ...
    const initializeConfig = () => {
        ...
        try {
            ...
            console.error(
                'configFromVite is not a valid AppConfigV1Schema',
                error,
                configFromVite
            );
        ...
        const { storePrefix: _storePrefix, ...configData } = Utils.getValue(
            namespace,
            {}
        );
        ...
        try {
            ...
            console.error(
                'configData is not a valid AppSettingsV1Schema',
                error,
                configData
            );
        ...
        return {
            ...
            lists: (validSettingsFromStorage.lists ||
                validConfigFromVite.lists) as ListConfig[],
            states:
                validSettingsFromStorage.states ||
                validConfigFromVite.states ||
                [],
            filters: {
